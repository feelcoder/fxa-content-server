...
define([
  ...
  registerSuite({
    ...
    'call activityEvent with service and entrypoint, without client_id and entryPoint': {
      setup: function () {
    ...
    'call activityEvent without service, with client_id': {
      setup: function () {
        write = process.stderr.write;
        process.stderr.write = sinon.spy();
    ...
    'call activityEvent with service, with client_id': {
      setup: function () {
        write = process.stderr.write;
        process.stderr.write = sinon.spy();
        return activityEvent('wibble', {}, {
    ...
    'call activityEvent without entrypoint, with entryPoint': {
      setup: function () {
        write = process.stderr.write;
        process.stderr.write = sinon.spy();
        return activityEvent('wibble', {}, {
    ...
    'call activityEvent with entrypoint, with entryPoint': {
      setup: function () {
        write = process.stderr.write;
        process.stderr.write = sinon.spy();
        return activityEvent('wibble', {}, {
